...
window.onload = function () {
    ...
    $.ajax({
        url: "?s=/index/Manage_house/getOneResold/id/"+$('#houseName').attr('data-id'),
        type: 'get',
...
$('#modifyItem').click(function () {
    ...
    $.ajax({
        url: "?s=/index/Manage_house/updateResoldInfo/id/"+$('#houseName').attr('data-id'),
        // url:"index/addtoHouse/"+$('#houseName').attr('data-id')+"?XDEBUG_SESSION_START=12900",
        type: 'post',
        data: upData,
        dataType: 'json',
        success: function (data) {
